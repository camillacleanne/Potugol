...
create table tb_funcionaries (
    ...
    -- data e hora baseado fuso horario atual ano-mes-dia
    data_atualizacao timestamp not null,
	primary key (`id`) 
);

insert into tb_funcionaries (nome, ative, nascimento, hora_nasc, email, data_criacao, 
data_atualizacao) 
values ("argel", true, "1999-08-16", "07:30:00", "argel@generation.org", 
current_timestamp(), current_timestamp()
);
INSERT INTO `rh_gen`.`tb_funcionaries` (`nome`, `ative`, `nascimento`, `hora_nasc`, `email`, `data_criacao`, `data_atualizacao`) 
VALUES ('lucas', '1', '1997-04-26', '10:00:00', 'passos@generation', current_timestamp(), current_timestamp());

INSERT INTO `rh_gen`.`tb_funcionaries` (`nome`, `ative`, `nascimento`, `hora_nasc`, `email`, `data_criacao`, `data_atualizacao`) VALUES ('lari', '1', '1995-06-14', '13:45:00', 'larissa@generation.org', '2021-09-22 09:50:09', '2021-09-22 09:51:00');
UPDATE `rh_gen`.`tb_funcionaries` SET `email` = 'passos@generation.org' WHERE (`id` = '2');

SELECT * FROM rh_gen.tb_funcionaries;
...
from tb_funcionaries;tb_livros
